...
// 🔹 STATIC PAGES
// ─────────────────────────────────────────────────────────────
Route::get('/tentang-kami', [PageController::class, 'tentang'])->name('pages.tentang');
Route::get('/bantuan', [PageController::class, 'bantuan'])->name('pages.bantuan');
...
Route::middleware(['auth', 'role:admin'])
    ...
    ->group(function () {
        ...
        // Kelola Kriteria CF (Preferensi Sistem)
