                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-2 flex-wrap">
                                        <button type="button" class="btn btn-sm btn-success save-single-btn" 
                                                ...
                                                data-pestisida-id="{{ $pestisidaItem->id }}">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.save-single-btn').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            const pestisidaId = this.dataset.pestisidaId;
            const row = this.closest('tr');
            const mbInput = row.querySelector('input[name*="[mb]"]');
            const mdInput = row.querySelector('input[name*="[md]"]');
            ...
            fetch("{{ route('admin.rating.pestisida.simpan') }}", {
                method: 'POST',
                headers: {
    ...
    // Save all single row button - simpan semua untuk satu penyakit-pestisida combination
