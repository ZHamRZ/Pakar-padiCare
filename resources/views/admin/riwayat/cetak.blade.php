...
<body>
    ...
    <div class="toolbar">
        ...
        <a class="btn btn-secondary" href="{{ route('admin.riwayat.show', $rekomendasi->id) }}">Kembali</a>
    </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item->pupuk->dosis_per_hektar ? $item->pupuk->dosis_per_hektar . ' ' . $item->pupuk->satuan_dosis : '-' }}</td>
