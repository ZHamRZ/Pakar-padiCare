            ...
            <div class="detail-grid">
                ...
                <div class="detail-box">
                    ...
                    <div class="detail-list">
                        ...
                        <p><strong>Harga per Satuan</strong>
                            {{ $formatUnitPrice($item->pupuk->harga_per_kg ?? null, $item->pupuk->satuan ?? 'kg') }}
                        </p>
                ...
                <div class="detail-box">
                    ...
                    <div class="detail-list">
                        ...
                        <p><strong>Harga</strong>
                            {{ $formatUnitPrice($item->pestisida->harga ?? null, $item->pestisida->satuan_harga ?? null) }}
                        </p>
